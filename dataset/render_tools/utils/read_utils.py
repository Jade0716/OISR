...
def load_anno_dict(save_path, filename):
    ...
    print("NPCS Dictionary Keys:", list(npcs_dict.keys()))
    print("npcs_map Shape:", npcs_dict['npcs_map'].shape)
    print("npcs_map Content Sample:", npcs_dict['npcs_map'][:5])
