...
def get_12_cam_positions(theta_deg: float, distance: float, phi_start: float = 0.0, phi_end: float = 360.0):
    cam_positions = []
    phis = np.linspace(phi_start, phi_end, num=101)[:-1]  # 生成12个角度点（闭区间[0,360)）
