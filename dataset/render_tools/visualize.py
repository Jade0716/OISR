...
from utils.visu_utils import save_image, visu_depth_map, visu_2D_seg_map, visu_3D_bbox_semantic, \
    visu_3D_bbox_pose_in_color, \
    visu_NPCS_map, visu_point_cloud_with_bbox_semantic, visu_point_cloud_with_bbox_pose_color, \
    visu_NPCS_in_3D_with_bbox_pose_color, \
    visu_point_cloud

if __name__ == "__main__":

    parser = ArgumentParser()
    parser.add_argument('--model_id', type=int, default=100189)
    parser.add_argument('--category', type=str, default='Box')
    ...
    txt_save_path = pjoin(save_path, f'{filename}.txt')
