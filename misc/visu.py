...
def process_gapartnetfile(GAPARTNET_DATA_ROOT, name, split="train"):
    ...
    pc,_, rgb, semantic_label, instance_label, npcs_map,_ = torch.load(data_path)
...
def visualize_gapartnet(
    ...
    points_input, trans, semantic_label, instance_label, npcs_map = process_gapartnetfile(GAPARTNET_DATA_ROOT, name,
                                                                                          split)
